...
HD_PWD='C:/Users/uhtrk/Desktop/vhdl/ex2/pes_dhl_ex2/Ex2/ex2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rechenwerk_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rechenwerk_TB.tcl
